...
class DPOTrainer(Trainer):
    ...
    def __init__(
        ...
        loss_use_weight:Optional[bool] = True,
    ):
        self.loss_use_weight=loss_use_weight
    ...
    def concatenated_inputs(self, batch: Dict[str, Union[List, torch.LongTensor]]) -> Dict[str, torch.LongTensor]:
        ...
        # for k in batch:
        #     if k.startswith("dpo_weight"):
        #         concatenated_key = k.replace("dpo_weight", "concatenated_dpo_weights")
        #         concatenated_batch[concatenated_key]=batch[k].repeat(2,1)
    ...
    def dpo_loss(
        ...
        if self.loss_use_weight:
            weighted_losses = losses * batch_weight
        ...
        return weighted_losses, chosen_rewards, rejected_rewards
